-- Phase 4 fix: disambiguate consume_public_rate_limit RETURNING column references.
-- Existing function can fail with: column reference "reset_at" is ambiguous.
...
begin
  ...
  set
    ...
    updated_at = now_utc
  returning rate_limits.request_count, rate_limits.reset_at
